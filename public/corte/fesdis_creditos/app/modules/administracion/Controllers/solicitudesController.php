...
class Administracion_solicitudesController extends Administracion_mainController
{
	...
	public function guardarincompletaAction(){
		...
		/*
		$mensaje = "
		<img src='http://creditos.fesdis.com.co/corte/banner.png'><br>
		...
		*/
		...
		$mensaje = "
		<img src='http://fonkobacreditos.omegasol.tk/corte/banner.png'><br>
        ...
        $emailModel->getMail()->setFrom("notificaciones@fonkoba.com.co", "Notificaciones Sistema Solicitud de créditos");
        $emailModel->getMail()->addBCC("desarrollo5@omegawebsystems.com");
	...
	function enviaracomiteAction(){
		...
		$content = "<img src='http://fonkobacreditos.omegasol.tk/corte/banner.png'><br>Estimado(a) usuario. la solicitud de crédito WEB".$numero." requiere de su aprobación: ";
		...
		foreach ($aprobadores as $key => $value) {
	        ...
	        //envio
			$content1 = $content."<br><br><br>Por favor utilice el siguiente enlace para indicar su aprobación: <a href='http://fonkobacreditos.omegasol.tk/page/comite/?id=".$id."&e=".$codificado."'><button type='button' class='btn btn-primary' style='background:#0084C9; color:#FFFFFF; padding:5px 10px;'>Ingresar</button></a>";
	...
	function enviaracomiteespecialAction(){
		...
		foreach ($aprobadores as $key => $value) {
	        ...
	        //envio
			$content1 = $content."<br><br><br>Por favor utilice el siguiente enlace para indicar su aprobación: <a href='http://fonkobacreditos.omegasol.tk/page/comiteespecial/?id=".$id."&e=".$codificado."'><button type='button' class='btn btn-primary' style='background:#0084C9; color:#FFFFFF; padding:5px 10px;'>Ingresar</button></a>";
	...
	function enviaragerenciaAction(){
		...
		foreach ($aprobadores as $key => $value) {
	        ...
	        //envio
			$content1 = $content."<br><br><br>Por favor utilice el siguiente enlace para indicar su aprobación: <a href='http://fonkobacreditos.omegasol.tk/page/gerencia/?id=".$id."&e=".$codificado."'><button type='button' class='btn btn-primary' style='background:#0084C9; color:#FFFFFF; padding:5px 10px;'>Ingresar</button></a>";
	...
	public function enviarpagareAction()
	{
		...
		$ruta = "http://creditos.fesdis.com.co:8081/";
		...
		$asunto = "Solicitud de Crédito FONKOBA #".$numero." Aprobada";
		...
		$emailModel = new Core_Model_Mail();
        $emailModel->getMail()->setFrom("notificaciones@fonkoba.com", "Notificaciones FONKOBA");
	...
	public function enviarpagare2Action()
	{
		...
		*/
		...
		$asunto = "Solicitud de Crédito FONKOBA #".$numero." Aprobada [Plan de pagos]";
