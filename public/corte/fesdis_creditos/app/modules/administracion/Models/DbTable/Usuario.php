...
class Administracion_Model_DbTable_Usuario extends Db_Table
{
	...
	public function update($data,$id){
		...
		$user_telefono = $data['user_telefono'];
		$user_celular = $data['user_celular'];
		$query = " UPDATE user SET  user_state = '$user_state', user_names = '$user_names', user_email = '$user_email', user_level = '$user_level', user_user = '$user_user', user_delete = '$user_delete', user_current_user = '$user_current_user', user_code = '$user_code' $changepasword, user_telefono='$user_telefono', user_celular='$user_celular'  WHERE user_id = '".$id."' ";
		$res = $this->_conn->query($query);
	}
}