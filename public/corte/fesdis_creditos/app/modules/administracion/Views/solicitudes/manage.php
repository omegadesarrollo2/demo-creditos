...
<div class="container-fluid">
	<form class="text-left" enctype="multipart/form-data" method="post" action="<?php echo $this->routeform;?>" data-toggle="validator">
		<div class="content-dashboard">
			...
			<?php }?>
			<div class="row">
				<div class="col-12"><h4>Información de la solicitud</h4></div>
					...
					<label class="input-group">
						...
						<select class="form-control" name="linea" id="linea">
							...
							<?php foreach ($this->lineas AS $key => $value ){?>
								<option <?php if($this->getObjectVariable($this->content,"linea") == $value->codigo){ echo "selected"; }?> value="<?php echo $value->codigo; ?>" /> <?= $value->nombre; ?></option>
							<?php } ?>
						</select>
				...
				<div class="col-3 form-group d-none">
					...
					<label class="input-group">
						...
						<select class="form-control" name="frecuencia" id="frecuencia">
					        <option value="6" <?php if($this->getObjectVariable($this->content,"frecuencua") == "6" ){ echo "selected"; }?>>Prima (Semestral)</option>
					        <option value="12" <?php if($this->getObjectVariable($this->content,"frecuencua") == "12" ){ echo "selected"; }?>disabled="">Cesantia (Anual)</option>
						</select>
					</label>
					<div class="help-block with-errors"></div>
				</div>
				...
				<div class="col-12"><br><h4>Información de desembolso</h4></div>
				...
				<div class="col-3 form-group">
					...
					<label class="input-group">
						...
						<select class="form-control" name="linea_desembolso"   >
							<option value="">Seleccione...</option>
							<?php foreach ($this->lineas AS $key => $value ){?>
								<option <?php if($this->getObjectVariable($this->content,"linea_desembolso") == $value->codigo ){ echo "selected"; }?> value="<?php echo $value->codigo; ?>" /> <?= $value->nombre; ?></option>
							<?php } ?>
						</select>
					</label>
					<div class="help-block with-errors"></div>
					...
					<label class="input-group">
						...
						<select class="form-control" name="validacion" id="validacion">
							...
							<?php foreach ($this->validaciones AS $key => $value ){?>
								<option <?php if($this->getObjectVariable($this->content,"validacion") == $key ){ echo "selected"; }?> value="<?php echo $key; ?>" /> <?= $value; ?></option>
							<?php } ?>
						</select>
				...
				<div class="col-12"><br><h4>Información del solicitante</h4></div>
				<div class="col-3 form-group d-none">
					...
					<label class="input-group">
						...
						<select name="ciudad_documento" id="ciudad_documento" required class="form-control">
							<?php foreach ($this->ciudades as $ciudad): ?>
								<option value="<?php echo $ciudad->codigo; ?>" <?php if($this->content->ciudad_documento==$ciudad->codigo){ echo 'selected'; } ?> ><?php echo  utf8_encode(($ciudad->nombre))." (".utf8_encode($ciudad->departamento).")"; ?></option>
							<?php endforeach ?>
						</select>
					</label>
					<div class="help-block with-errors"></div>
					...
					<label class="input-group">
						...
						<select name="nomenclatura1" id="nomenclatura1" class="form-control d-none">
							...
							<?php foreach ($this->nomenclaturas as $key => $value): ?>
								<option value="<?php echo $value->codigo; ?>" <?php if($value->codigo==$this->content->nomenclatura1){ echo 'selected'; } ?> ><?php echo codificar($value->nombre); ?></option>
							<?php endforeach ?>
						</select>
				...
				<div class="col-3 form-group">
					...
					<label class="input-group">
						...
						<select name="ciudad_oficina" id="ciudad_oficina" required class="form-control">
							<?php foreach ($this->ciudades as $ciudad): ?>
								<option value="<?php echo $ciudad->codigo; ?>" <?php if($this->content->ciudad_oficina==$ciudad->codigo){ echo 'selected'; } ?> ><?php echo  utf8_encode(($ciudad->nombre))." (".utf8_encode($ciudad->departamento).")"; ?></option>
							<?php endforeach ?>
						</select>
					</label>
					<div class="help-block with-errors"></div>
				...
				<div class="col-4 form-group">
					...
					<label class="input-group">
						...
						<select name="nomenclatura2" id="nomenclatura2" class="form-control d-none">
							<option value="">Nomenclatura</option>
							<?php foreach ($this->nomenclaturas as $key => $value): ?>
								<option value="<?php echo $value->codigo; ?>" <?php if($value->codigo==$this->content->nomenclatura2){ echo 'selected'; } ?> ><?php echo codificar($value->nombre); ?></option>
							<?php endforeach ?>
						</select>
				...
				<div class="col-3 form-group">
					...
					<label class="input-group">
						...
						<select name="ciudad_residencia" id="ciudad_residencia" required class="form-control">
							<?php foreach ($this->ciudades as $ciudad): ?>
								<option value="<?php echo $ciudad->codigo; ?>" <?php if($this->content->ciudad_residencia==$ciudad->codigo){ echo 'selected'; } ?> ><?php echo  utf8_encode(($ciudad->nombre))." (".utf8_encode($ciudad->departamento).")"; ?></option>
							<?php endforeach ?>
						</select>
					</label>
					<div class="help-block with-errors"></div>
				...
				<div class="col-12"><br><h4>Observaciones</h4></div>

				<div class="col-12 form-group">
					<label for="observaciones" class="form-label" >observaciones asociado</label>
					<textarea name="observaciones" id="observaciones"   class="form-control tinyeditor" rows="5"   ><?= $this->content->observaciones; ?></textarea>
					<div class="help-block with-errors"></div>
				</div>
				<div class="col-12 form-group">
					<label for="observacion_analista" class="form-label" >observacion analista</label>
					<textarea name="observacion_analista" id="observacion_analista"   class="form-control tinyeditor" rows="5"   ><?= $this->content->observacion_analista; ?></textarea>
					<div class="help-block with-errors"></div>
				</div>
				<div class="col-12 form-group d-none">
					<label for="observacion_auxiliar" class="form-label" >observacion auxiliar</label>
					<textarea name="observacion_auxiliar" id="observacion_auxiliar"   class="form-control tinyeditor" rows="5"   ><?= $this->content->observacion_auxiliar; ?></textarea>
					<div class="help-block with-errors"></div>
				</div>
				<div class="col-12 form-group d-none">
					<label for="observacion_riesgo" class="form-label" >observacion riesgo</label>
					<textarea name="observacion_riesgo" id="observacion_riesgo"   class="form-control tinyeditor" rows="5"   ><?= $this->content->observacion_riesgo; ?></textarea>
					<div class="help-block with-errors"></div>
				</div>

				<div class="col-12"><br><h4>Información estado de la solicitud</h4></div>
				<div class="col-3 form-group">
