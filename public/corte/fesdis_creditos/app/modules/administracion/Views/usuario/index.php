					...
					<tr>
						...
						<td class="text-right">
							<div>
								...
								<span data-toggle="tooltip" data-placement="top" title="Eliminar" class="d-none"><a class="btn btn-rojo btn-sm" data-toggle="modal" data-target="#modal<?= $id ?>"  ><i class="fas fa-trash-alt" ></i></a></span>
							</div>
							<!-- Modal -->
