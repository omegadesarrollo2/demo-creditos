...
class Page_sistemaController extends Page_mainController
{
	...
	public function asignaranalistaAction(){
        ...
        if($solicitud->tipo_garantia=="2"){
			...
			$content = "<img src='http://fendesacreditos.omegasolucionesweb.com/corte/banner.png'><br>Estimado(a) <b>".$nombres_codeudor."</b>, el/la asociado(a) <b>".$nombres_asociado."</b> lo ha ingresado como codeudor en la solicitud de crédito <b>No. WEB".$numero."</b> del sistema de solicitudes de crédito de FESDIS por valor de <b>$".number_format($valor)."<b/><br><br>Por favor ingrese en el siguiente enlace para completar su información personal: <a href='http://creditos.fesdis.com.co/page/codeudor/?id=".$id."&e=".$correo_codificado."'><button type='button' class='btn btn-primary' style='background:#0084C9; color:#FFFFFF; padding:5px 10px;'>Ingresar</button></a>";
