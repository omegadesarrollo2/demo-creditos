	...
	<div class="row">
			<div class="col-12">
				...
				<div class="row form-group formulario caja-formulario">
					...
					<input type="hidden" value="<?php echo $this->fecha_nacimiento; ?>" name="fecha_nacimiento">
					...
					<input type="hidden" value="<?php echo $this->correo_personal; ?>" name="correo_personal">
				...
				<div class="row form-group formulario caja-formulario">
					...
					<div class="col-md-6 col-lg-3 d-none"><label>Número asignado</label> <input type="text" name="numero_asignado" id="numero_asignado" value="<?php echo $this->numero_asignado; ?>"  class="form-control"  /></div>
