<?php if(($this->aprobador->user_id>0) ){ ?>

<form action="/page/cambiosolicitud/guardar/" method="post">
	...
	<div class="container">
		<div class="row">
			<div class="col-12">
				...
				<div class="col-12">
					<div class="col-md-12 titulo-seccion no-padding">Aprobación cambio de condiciones</div>
					...
					<?php if(count($this->existe) == 0){ ?>
						<div class="row form-group formulario caja-formulario">
							<div class="col-md-6 col-lg-3"><label>Nombre:</label><br><span class="negro"><?php echo $this->aprobador->user_names; ?></span></div>
							<div class="col-md-6 col-lg-3"><label>¿Acepta los cambios?</label>
							...
							<div class="col-md-6 col-lg-9 d-none"><label>Observación</label> <input type="text" name="observacion" id="observacion" value="" class="form-control" /></div>
						</div>
					<?php } ?>
				</div>
				...
				<?php } else {?>
					<div class="col-12 text-center">Usted ya dio su opinión respecto al crédito</div>
				<?php } ?>
