<?php if(($this->aprobador->user_id>0) and ($this->solicitud->validacion=="0" or $this->solicitud->validacion=="6" or $this->solicitud->validacion=="4" or $this->solicitud->validacion=="3") AND $this->solicitud->acepto_cambios=="0" AND $this->solicitud->confimar_solicitud=="0" ){ ?>
	...
	<div class="container">
		<div class="row">
			<div class="col-12">
				...
				<div class="col-12">
					<div class="col-md-12 titulo-seccion no-padding">Aprobación Junta Directiva</div>
