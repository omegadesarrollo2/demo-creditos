...
Por favor actualice su información
                ...
                <select class="form-control" id="nivel_escolaridad" name="nivel_escolaridad" required>
                    ...
                    <option value="Ninguno" <?php if ($this->estudios=="Ninguno"){ ?> selected<?php }?>>Ninguno</option>
                    <option value="Primaria" <?php if ($this->estudios=="Primaria"){ ?> selected<?php }?>>Primaria</option>
                    <option value="Secundaria" <?php if ($this->estudios=="Secundaria"){ ?> selected<?php }?>>secundaria</option>
                    <option value="Bachillerato" <?php if ($this->estudios=="Bachillerato"){ ?> selected<?php }?>>Bachillerato</option>
                    <option value="Técnico" <?php if ($this->estudios=="Técnico"){ ?> selected<?php }?>>Técnico</option>
                    <option value="Tecnólogo" <?php if ($this->estudios=="Tecnólogo"){ ?> selected<?php }?>>Tecnólogo</option>
                    <option value="Pregrado" <?php if ($this->estudios=="Pregrado"){ ?> selected<?php }?>>Pregrado</option>
                    <option value="Posgrado" <?php if ($this->estudios=="Posgrado"){ ?> selected<?php }?>>Posgrado</option>
                    <option value="Especialización" <?php if ($this->estudios=="Especialización"){ ?> selected<?php }?>>Especialización</option>
                </select>
            </div>
			<div class="col-md-3 ">
				...
				<option value="" <?php if (!$this->personas_cargo){ ?> selected<?php }?>>Seleccione...</option>
                    ...
                    <option value="Menores de 18 años" <?php if ($this->personas_cargo=="Menores de 18 años"){ ?> selected<?php }?>>Menores de 18 años</option>
                </select>
            </div>
						...
						<option value="" <?php if (!$this->tipo_vivienda){ ?> selected<?php }?>>Seleccione...</option>
							...
							<option value="Alquilada" <?php if ($this->tipo_vivienda=="Alquilada"){ ?> selected<?php }?>>Alquilada</option>
