<?php 
if(($this->aprobador->user_id>0) and ($this->solicitud->validacion=="0" or $this->solicitud->validacion=="6" or $this->solicitud->validacion=="4" or $this->solicitud->validacion=="3" or $this->solicitud->validacion=="9") AND ($this->solicitud->acepto_cambios=="0" || $this->solicitud->acepto_cambios==null) AND ($this->solicitud->confimar_solicitud=="0" || $this->solicitud->confimar_solicitud==null)  AND $this->solicitud->id!=3165 ){ ?>

<form action="/page/analista/guardar/" method="post">
	...
	<div class="container">
		<div class="row">
			<div class="col-12">
				...
				<div class="col-12">
					<div class="col-md-12 titulo-seccion no-padding">Aprobación Analista</div>
