<?php if ($_GET['mod'] != "detalle_solicitud") { ?>
  <div class="header-content">
    <div class="col-sm-3 ">
      <a href="/sistema/" class="logo2-bx"><img src="/skins/page/images/logo.jpg" class="logo2"></a>
    </div>
    ...
    <div class="menu-toggle">
      <nav class="">
        <ul>
          <li><a href="/page/sistema/">Inicio<i class="fas fa-home"></i></a></li>
          <li><a href="/page/sistema/solicitudes/">Solicitudes<i class="fas fa-list-ol"></i></a></li>
          <li class="d-none"><a href="/page/sistema/perfil/">Perfil</a></li>
          <li class="d-none"><a href="/page/sarlaft/">Sarlaft</a></li>
          <li><a href="/page/login/logout/">Salir <i class="fas fa-sign-out-alt"></i></a></li>
        </ul>
      </nav>
    </div>
  </div>
