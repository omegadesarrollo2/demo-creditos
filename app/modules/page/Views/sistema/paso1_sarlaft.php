...
<div class="container">
	<div class="row">
			<div class="col-12">
				...
				<div class="col-12">
					En caso fortuito o fuerza mayor el Fondo de Empleados Grupo Endesa Colombia “FONDTODOS” – hará entrega a sus beneficiarios dentro de los términos establecidos en los estatutos y de acuerdo a la normatividad legal vigente (Articulo 15 parágrafo 1 Estatutos vigentes FENDIS) los saldos a favor en razón de su asociación.
				...
				<div class="row form-group formulario caja-formulario">
					<div class="col-12 negro input-terminos"><br>
						...
						3. Eximo a Fondo de Empleados Grupo Endesa Colombia “FONDTODOS”, de toda responsabilidad que se derive del comportamiento o el que se ocasione por la información falsa ó errónea suministrada en la presente declaración y en los documentos que respaldan o soporten mis afirmaciones.
						4. Autorizo a Fondo de Empleados Grupo Endesa Colombia “FONDTODOS”, para que verifique y realice las consultas que estime necesarias con el propósito de confirmar la información registrada en este formulario.
						5. Los recursos que utilizo para realizar los pagos e inversiones en Fondo de Empleados Grupo Endesa Colombia “FONDTODOS” tienen procedencia lícita y están soportados con el desarrollo de actividades legítimas.
						...
						7. Estoy informado de mi obligación de actualizar anualmente la información que solicite la entidad por cada producto o servicio que utilice, suministrando la información documental exigida por Fondo de Empleados Grupo Endesa Colombia “FONDTODOS” para dar cumplimiento a la normatividad vigente.<br><br>
