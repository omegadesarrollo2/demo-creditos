...
class Page_analistaController extends Page_mainController
{
  ...
  public function indexAction()
  {
    ...
    $this->_view->codeudor2 = $codeudor = $codeudorModel->getList(" solicitud='$id' AND codeudor_numero='2' ", "")[0];
  ...
  public function guardarAction()
  {
    ...
    if($aprobacion == '1'){
      ...
      $aprobacion_id = '6';
      $estado = 'Cambio de condiciones';
    }
    $solicitudModel->editField($id, "validacion", $aprobacion_id);
    ...
    $dataestado["observacion"] = '';
    $logestado->insert($dataestado);
    
    $solicitud_data = $solicitudModel->getById($id);
    
    if ($solicitud_data->recoger_credito != 1 && $estado == 'Aprobado') {
  ...
  public function enviaraprobacion($id, $validacion, $observacion)
  {
    ...
    if ($validacion != "4" or $validacion != "3") {
      $content = '<br>
