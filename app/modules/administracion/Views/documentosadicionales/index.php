...
<div class="container-fluid">
  <div align="right" class="pt-2"><a class="btn btn-warning btn-sm search-button mt-3 ml-auto"
      href="/administracion/solicitudes">Regresar<i class="fas fa-chevron-left"></i></a></div>
      ...
      <div class="row">
        <div class="col-3">
          ...
          <label class="input-group">
            ...
            <input type="text" class="form-control" name="titulo"
              value="<?php echo $this->getObjectVariable($this->filters, 'titulo') ?>"></input>
          </label>
        </div>
        <div class="col-3">
          <label>archivo</label>
          <label class="input-group">
            ...
            <input type="text" class="form-control" name="archivo"
              value="<?php echo $this->getObjectVariable($this->filters, 'archivo') ?>"></input>
          </label>
        </div>
        <div class="col-3">
          <label>fecha</label>
        ...
        <div class="col-3">
          ...
          <label class="input-group">
            ...
            <input type="text" class="form-control" name="quien"
              value="<?php echo $this->getObjectVariable($this->filters, 'quien') ?>"></input>
          </label>
        </div>
        <div class="col-3">
          ...
          <label class="input-group">
            ...
            <input type="text" class="form-control" name="solicitud"
              value="<?php echo $this->getObjectVariable($this->filters, 'solicitud') ?>"></input>
          </label>
        </div>
        <div class="col-3">
          <label>&nbsp;</label>
      ...
      <div class="row">
        ...
        <div class="col-3">
          <div class="text-right"><a class="btn btn-sm btn-success"
              href="<?php echo $this->route."\manage"."?solicitud=".$this->solicitud.""; ?>"> <i
      ...
      <table class=" table table-striped  table-hover table-administrator text-left">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a href="/images/<?php echo $content->archivo;?>" target="_blank"><?php echo $content->archivo;?></a>
            </td>
            <td><?=$content->fecha;?></td>
            ...
            <td class="text-right">
              <div>
                ...
                <span data-toggle="tooltip" data-placement="top" title="Eliminar"><a class="btn btn-rojo btn-sm"
                    data-toggle="modal" data-target="#modal<?= $id ?>"><i class="fas fa-trash-alt"></i></a></span>
              </div>
              <!-- Modal -->
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <a class="btn btn-danger"
                        href="<?php echo $this->route;?>/delete?id=<?= $id ?>&csrf=<?= $this->csrf;?><?php echo ''.'&solicitud='.$this->solicitud; ?>">Eliminar</a>
                    </div>
                  </div>
                </div>
              </div>
