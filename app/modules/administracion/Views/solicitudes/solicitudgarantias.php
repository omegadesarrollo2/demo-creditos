<form action="/administracion/solicitudes/updategarantia" class="mt-5" method="post">
          ...
          <div class="row form-group">
            <div class="col-md-12 col-lg-12">
              <div class="row  text-center">
                ...
                <select name="garantia_adicional" id="garantia_adicional" onchange="seleccion_tipo_garantia2();"
                  class="form-control col-lg-4 offset-lg-4">
                  <option value="">Seleccione</option>
                  <?php foreach ($this->garantias as $key => $garantia): ?>
                  <option value="<?php echo $garantia->garantia_id; ?>"
                    <?php if($this->solicitud->garantia_adicional==$garantia->garantia_id){ echo 'selected="selected"'; }  ?>>
                    <?php echo utf8_encode($garantia->garantia_nombre); ?></option>
                  <?php endforeach ?>
                </select>
              </div>
              <br>
  ...
  <div class="text-center"><button class="btn btn-primary" type="submit">Guardar</button></div>
  </div>
