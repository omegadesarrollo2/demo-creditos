						...
						<td class="text-end" width="200">
							<div>
								<?php if($_SESSION['kt_login_level']!="12"){ ?>
									...
									<a class="btn btn-verde btn-sm" href="/administracion/solicitudes/agregarcreditos?id=<?= $id ?>" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Relacionar créditos"><i class="fas fa-search"></i></a>
								<?php } ?>
								<a class="btn btn-azul-claro btn-sm" href="<?php echo $this->route;?>/formatoacta?id=<?= $id ?>" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Formato acta"><i class="fas fa-file"></i></a>
								<a class="btn btn-warning btn-sm" href="<?php echo $this->route;?>/formatoanexo?id=<?= $id ?>" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Formato anexo"><i class="fas fa-file"></i></a>
								<?php if($_SESSION['kt_login_level']!="12"){ ?>
