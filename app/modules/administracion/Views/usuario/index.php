...
<div class="container-fluid">
  <form action="<?php echo $this->route; ?>" method="post" class="filters">
  ...
  <div class="content-dashboard table-wrapper">
          ...
          <tr>
            ...
            <td class="text-end">
              <div>
                ...
                <span data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Eliminar" class="d-none"><a
