        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="it_id" value="<?php echo $this->getObjectVariable($this->filters, 'it_id') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>it_user</label>
		            ...
		            <input type="text" class="form-control" name="it_user" value="<?php echo $this->getObjectVariable($this->filters, 'it_user') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>it_email</label>
		            <label class="input-group">
							<div class="input-group-prepend">
								<span class="input-group-text input-icono fondo-rosado " ><i class="fas fa-pencil-alt"></i></span>
							</div>
		            <input type="text" class="form-control" name="it_email" value="<?php echo $this->getObjectVariable($this->filters, 'it_email') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
		...
		<table class=" table table-striped  table-hover table-administrator text-start">
			...
			<tbody>
				...
				<?php $id =  $content->id; ?>
					<tr>
						<td><?=$content->it_id;?></td>
						<td><?=$content->it_user;?></td>
						<td><?=$content->it_email;?></td>
						<td class="text-end">
							<div>
