<ul>
  ...
  <?php if ($_SESSION['kt_login_level'] == "1" or $_SESSION['kt_login_level'] == "3" or $_SESSION['kt_login_level'] == "8" or $_SESSION['kt_login_level'] == "12" or $_SESSION['kt_login_level'] == "13"  or $_SESSION['kt_login_level'] == "16"  or $_SESSION['kt_login_level'] == "17" or $_SESSION['kt_login_level'] == "18") { ?>
    <?php if ($_SESSION['kt_login_level'] != "12") { ?>
      <li class="nav-item <?php if ($this->botonpanel == 13) { ?> active <?php } ?>">
  ...
  <?php if ($_SESSION['kt_login_level'] == "1" or $_SESSION['kt_login_level'] == "3" or $_SESSION['kt_login_level'] == "10" or $_SESSION['kt_login_level'] == "8" or $_SESSION['kt_login_level'] == "16") { ?>
    <li class="nav-item <?php if ($this->botonpanel == 23) { ?> active <?php } ?>">
  ...
  <?php } ?>
  <?php
  $configArray = array(5, 8, 9, 14, 15, 24);
  ?>
  <li class="nav-item dropdown-li <?php if (in_array($this->botonpanel, $configArray)) { echo 'active'; } ?>">
    <a href="/administracion/usuario" class="dropdown-link <?php if (in_array($this->botonpanel, $configArray)) { echo 'active'; } ?>">
    ...
    <ul <?php if (in_array($this->botonpanel, $configArray)) {
          echo 'style="display: block;"';
        } ?>>
      <li class="nav-item <?php if ($this->botonpanel == 5) { ?> active <?php } ?>">
        <a href="/administracion/lineas">
          <i class="far fa-credit-card"></i>
          Líneas de crédito
        </a>
      </li>
      <li class="nav-item <?php if ($this->botonpanel == 8) { ?> active <?php } ?>">
        <a href="/administracion/usuario/exportar/?excel=1">
          <i class="far fa-file-excel"></i>
          Exportar usuarios
        </a>
      </li>
      <li class="nav-item <?php if ($this->botonpanel == 9) { ?> active <?php } ?>">
        <a href="/administracion/importarasociados/manage?id=1" class="nav-link">
          <i class="fas fa-file-excel"></i>
          Importar asociados
        </a>
      </li>
      <li class="nav-item <?php if ($this->botonpanel == 14) { ?> active <?php } ?>">
        <a href="/administracion/gestores/">
          <i class="fas fa-user-ninja"></i>
          Gestores comerciales
        </a>
      </li>
      <li class="nav-item <?php if ($this->botonpanel == 15) { ?> active <?php } ?>">
        <a href="/administracion/bancos/">
          <i class="fas fa-university"></i>
          Bancos
        </a>
      </li>
      <li class="nav-item <?php if ($this->botonpanel == 24) { ?> active <?php } ?>">
