...
class Administracion_Model_DbTable_Lineas extends Db_Table
{
	...
	public function insert($data){
		...
		$linea_api = $data['linea_api'];
		$query = "INSERT INTO lineas_credito( codigo, nombre, detalle, tasa_cobrada, tasa_real, efectivo_anual, max_meses, maxMonto, descripcionGeneral, requisitos, activo, archivo1, archivo2, archivo3, archivo4, archivo22, archivo23, archivo24, certificado_tradicion, estado_obligacion, estado_obligacion2, estado_obligacion3, factura_proforma, recibo_matricula,orden_medica,certificacion,cotizacion,peritaje_vehiculo,evidencia_calamidad,impuesto_vehiculo,soat,min_meses, linea_api) VALUES ( '$codigo', '$nombre', '$detalle', '$tasa_cobrada', '$tasa_real', '$efectivo_anual', '$max_meses', '$maxMonto', '$descripcionGeneral', '$requisitos', '$activo', '$archivo1', '$archivo2', '$archivo3', '$archivo4', '$archivo22', '$archivo23', '$archivo24', '$certificado_tradicion', '$estado_obligacion', '$estado_obligacion2', '$estado_obligacion3', '$factura_proforma', '$recibo_matricula','$orden_medica','$certificacion','$cotizacion','$peritaje_vehiculo','$evidencia_calamidad','$impuesto_vehiculo','$soat','$min_meses', '$linea_api')";
		//echo $query."<br>";
