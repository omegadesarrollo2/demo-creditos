...
define('PUBLIC_PATH', APP_PATH . "../public/");
  ...
  const CLIENT_ID = "0oap0lmbt8DIofFZ10h7";
  const CLIENT_SECRET = "MyXK_QM0d_2ogXj84NIeOOYh8fBOK8ACkawRCvxj";
  const DC_USER = "800112808";
  const DC_PASSWORD = "04MOM";
...
$env = "development";
if (strpos($_SERVER['HTTP_HOST'], "democreditos.omegasolucionesweb.com") !== false) {
  $env = "staging";
